/**
 * Canonical schema migration guide for Apito MCP agents.
 * Human-readable copy: SCHEMA_MIGRATION_GUIDE.md (keep in sync).
 */
export function getSchemaMigrationGuideContent(): string {
    return `# Apito schema migration guide (MCP)
